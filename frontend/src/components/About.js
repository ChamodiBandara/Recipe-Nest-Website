...
function About() {
  ...
  return (
    <div className="about-page">
      ...
      {/* NOTE: In React it should be className not class */}
      <section className="what-we-offer">
        <h2 className="offer-title">What We Offer ?</h2>
        <div className="offer-container">
          <div className="offer-left">
            <img src={chef} alt="Chef presenting recipes" className="offer-image" />
          </div>
      ...
      <section className="recipe-call">
        <div className="recipe-call-container">
          ...
          <div className="recipe-call-p">
            Bring Your Recipes to the Nest is your chance to share your culinary creativity!
            Add your unique recipe ideas, contribute new flavors, and inspire fellow food enthusiasts.
            By sharing your ideas with us, you’ll become a valued part of our community.
          </div>

          <AddRecipeButton className="add-recipes-button" />
        </div>
      </section>

      {/* ✅ Replaced Find More Recipes with conditional section */}
      <section className="find-recipes">
        <h2 className="find-recipes-title">
          {isLoggedIn ? "Your Recipes" : "Manage Your Recipes"}
        </h2>

        <div className="find-recipes-container">
          {isLoggedIn ? (
            <>
              <p className="find-recipes-text">
                View the recipes you added, and edit or delete them anytime.
              </p>
              <Link to="/my-recipes">
                <button className="find-recipes-button">My Recipes</button>
              </Link>
            </>
          ) : (
            <>
              <p className="find-recipes-text">
                Login to add, edit, and delete your recipes.
              </p>
              <Link to="/login">
                <button className="find-recipes-button">Login</button>
              </Link>
            </>
          )}
        </div>
